...
class FileMonitor : ObjectG
{
  ...
  {
    bool _retval;
    _retval = g_file_monitor_cancel(cPtr!GFileMonitor);
    return _retval;
  }
  ...
  {
    g_file_monitor_emit_event(cPtr!GFileMonitor, child ? (cast(ObjectG)child).cPtr!GFile : null, otherFile ? (cast(ObjectG)otherFile).cPtr!GFile : null, eventType);
  }
  ...
  {
    bool _retval;
    _retval = g_file_monitor_is_cancelled(cPtr!GFileMonitor);
    return _retval;
  }
  ...
  {
    g_file_monitor_set_rate_limit(cPtr!GFileMonitor, limitMsecs);
  }
   ...
   */
  ulong connectChanged(void delegate(File file, File otherFile, FileMonitorEvent eventType, FileMonitor fileMonitor) dlg, ConnectFlags flags = ConnectFlags.Default)
  {
