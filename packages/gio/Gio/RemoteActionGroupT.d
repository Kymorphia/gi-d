...
template RemoteActionGroupT(TStruct)
{
  ...
  override void activateActionFull(string actionName, Variant parameter, Variant platformData)
  {
    ...
    g_remote_action_group_activate_action_full(cPtr!GRemoteActionGroup, _actionName, parameter ? parameter.cPtr!GVariant : null, platformData ? platformData.cPtr!GVariant : null);
  }
  ...
  {
    const(char)* _actionName = actionName.toCString(false);
    g_remote_action_group_change_action_state_full(cPtr!GRemoteActionGroup, _actionName, value ? value.cPtr!GVariant : null, platformData ? platformData.cPtr!GVariant : null);
  }
}
