...
template ListModelT(TStruct)
{
  ...
  {
    GType _retval;
    _retval = g_list_model_get_item_type(cPtr!GListModel);
    return _retval;
  }
  ...
  {
    uint _retval;
    _retval = g_list_model_get_n_items(cPtr!GListModel);
    return _retval;
  }
  ...
  {
    ObjectC* _cretval;
    _cretval = g_list_model_get_object(cPtr!GListModel, position);
  ...
  {
    g_list_model_items_changed(cPtr!GListModel, position, removed, added);
  }
  ...
  ulong connectItemsChanged(void delegate(uint position, uint removed, uint added, ListModel listModel) dlg, ConnectFlags flags = ConnectFlags.Default)
  {
    extern(C) void _cmarshal(GClosure* _closure, GValue* _returnValue, uint _nParams, const(GValue)* _paramVals, void* _invocHint, void* _marshalData)
    {
      ...
      _dgClosure.dlg(position, removed, added, listModel);
    }
