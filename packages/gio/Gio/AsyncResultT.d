...
template AsyncResultT(TStruct)
{
  ...
  {
    ObjectC* _cretval;
    _cretval = g_async_result_get_source_object(cPtr!GAsyncResult);
  ...
  {
    void* _retval;
    _retval = g_async_result_get_user_data(cPtr!GAsyncResult);
    return _retval;
  }
  ...
  {
    bool _retval;
    _retval = g_async_result_is_tagged(cPtr!GAsyncResult, sourceTag);
    return _retval;
  }
  ...
  override bool legacyPropagateError()
  {
    bool _retval;
    GError *_err;
    _retval = g_async_result_legacy_propagate_error(cPtr!GAsyncResult, &_err);
    if (_err)
