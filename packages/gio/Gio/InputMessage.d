...
class InputMessage
{
  ...
  {
    return cPtr!GInputMessage.numVectors;
  }

  @property void numVectors(uint propval)
  {
    cPtr!GInputMessage.numVectors = propval;
  }

  @property size_t bytesReceived()
  {
    return cPtr!GInputMessage.bytesReceived;
  }

  @property void bytesReceived(size_t propval)
  {
    cPtr!GInputMessage.bytesReceived = propval;
  }

  @property int flags()
  {
    return cPtr!GInputMessage.flags;
  }

  @property void flags(int propval)
  {
    cPtr!GInputMessage.flags = propval;
  }
}
