...
alias DBusInterfaceGetPropertyFunc = Variant delegate(DBusConnection connection, string sender, string objectPath, string interfaceName, string propertyName, ErrorG error);
alias DBusInterfaceMethodCallFunc = void delegate(DBusConnection connection, string sender, string objectPath, string interfaceName, string methodName, Variant parameters, DBusMethodInvocation invocation);
alias DBusInterfaceSetPropertyFunc = bool delegate(DBusConnection connection, string sender, string objectPath, string interfaceName, string propertyName, Variant value, ErrorG error);
...
alias SettingsBindGetMapping = bool delegate(Value value, Variant variant);
alias SettingsBindSetMapping = Variant delegate(Value value, VariantType expectedType);
alias SettingsGetMapping = bool delegate(Variant value, out void* result);
