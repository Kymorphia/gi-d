...
class UnixOutputStream : OutputStream, FileDescriptorBased, PollableOutputStream
{
  ...
  {
    bool _retval;
    _retval = g_unix_output_stream_get_close_fd(cPtr!GUnixOutputStream);
    return _retval;
  }
  ...
  {
    int _retval;
    _retval = g_unix_output_stream_get_fd(cPtr!GUnixOutputStream);
    return _retval;
  }
  ...
  {
    g_unix_output_stream_set_close_fd(cPtr!GUnixOutputStream, closeFd);
  }
}
