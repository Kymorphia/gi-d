...
class TestDBus : ObjectG
{
  ...
  void addServiceDir(string path)
  {
    ...
    g_test_dbus_add_service_dir(cPtr!GTestDBus, _path);
  }
  ...
  void down()
  {
    g_test_dbus_down(cPtr!GTestDBus);
  }
  ...
  {
    const(char)* _cretval;
    _cretval = g_test_dbus_get_bus_address(cPtr!GTestDBus);
  ...
  TestDBusFlags getFlags()
  {
    ...
    _cretval = g_test_dbus_get_flags(cPtr!GTestDBus);
  ...
  void stop()
  {
    g_test_dbus_stop(cPtr!GTestDBus);
  }
