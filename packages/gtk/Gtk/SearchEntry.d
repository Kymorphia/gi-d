...
class SearchEntry : Widget, Editable
{
   ...
   * Returns: Signal ID
   */
  ulong connectNextMatch(NextMatchCallback dlg, ConnectFlags flags = ConnectFlags.Default)
  {
    extern(C) void _cmarshal(GClosure* _closure, GValue* _returnValue, uint _nParams, const(GValue)* _paramVals, void* _invocHint, void* _marshalData)
    {
      assert(_nParams == 1, "Unexpected number of signal parameters");
    ...
    auto closure = new DClosure(dlg, &_cmarshal);
    return connectSignalClosure("next-match", closure, (flags & ConnectFlags.After) != 0);
  }
   ...
   * Returns: Signal ID
   */
  ulong connectPreviousMatch(PreviousMatchCallback dlg, ConnectFlags flags = ConnectFlags.Default)
  {
    extern(C) void _cmarshal(GClosure* _closure, GValue* _returnValue, uint _nParams, const(GValue)* _paramVals, void* _invocHint, void* _marshalData)
    {
      assert(_nParams == 1, "Unexpected number of signal parameters");
    ...
    auto closure = new DClosure(dlg, &_cmarshal);
    return connectSignalClosure("previous-match", closure, (flags & ConnectFlags.After) != 0);
  }
   ...
   * Returns: Signal ID
   */
  ulong connectSearchChanged(SearchChangedCallback dlg, ConnectFlags flags = ConnectFlags.Default)
  {
    extern(C) void _cmarshal(GClosure* _closure, GValue* _returnValue, uint _nParams, const(GValue)* _paramVals, void* _invocHint, void* _marshalData)
    {
      assert(_nParams == 1, "Unexpected number of signal parameters");
    ...
    auto closure = new DClosure(dlg, &_cmarshal);
    return connectSignalClosure("search-changed", closure, (flags & ConnectFlags.After) != 0);
  }
   ...
   * Returns: Signal ID
   */
  ulong connectSearchStarted(SearchStartedCallback dlg, ConnectFlags flags = ConnectFlags.Default)
  {
    extern(C) void _cmarshal(GClosure* _closure, GValue* _returnValue, uint _nParams, const(GValue)* _paramVals, void* _invocHint, void* _marshalData)
    {
      assert(_nParams == 1, "Unexpected number of signal parameters");
    ...
    auto closure = new DClosure(dlg, &_cmarshal);
    return connectSignalClosure("search-started", closure, (flags & ConnectFlags.After) != 0);
  }
   ...
   * Returns: Signal ID
   */
  ulong connectStopSearch(StopSearchCallback dlg, ConnectFlags flags = ConnectFlags.Default)
  {
    extern(C) void _cmarshal(GClosure* _closure, GValue* _returnValue, uint _nParams, const(GValue)* _paramVals, void* _invocHint, void* _marshalData)
    {
      assert(_nParams == 1, "Unexpected number of signal parameters");
    ...
    auto closure = new DClosure(dlg, &_cmarshal);
    return connectSignalClosure("stop-search", closure, (flags & ConnectFlags.After) != 0);
  }
}
