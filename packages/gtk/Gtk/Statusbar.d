...
class Statusbar : Widget
{
   ...
   * Returns: Signal ID
   */
  ulong connectTextPopped(TextPoppedCallback dlg, ConnectFlags flags = ConnectFlags.Default)
  {
    ...
    return connectSignalClosure("text-popped", closure, (flags & ConnectFlags.After) != 0);
  }
   ...
   * Returns: Signal ID
   */
  ulong connectTextPushed(TextPushedCallback dlg, ConnectFlags flags = ConnectFlags.Default)
  {
    extern(C) void _cmarshal(GClosure* _closure, GValue* _returnValue, uint _nParams, const(GValue)* _paramVals, void* _invocHint, void* _marshalData)
    {
      assert(_nParams == 3, "Unexpected number of signal parameters");
    ...
    auto closure = new DClosure(dlg, &_cmarshal);
    return connectSignalClosure("text-pushed", closure, (flags & ConnectFlags.After) != 0);
  }
}
