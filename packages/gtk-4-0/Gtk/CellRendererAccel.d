...
class CellRendererAccel : CellRendererText
{
   ...
   * Returns: Signal ID
   */
  ulong connectAccelCleared(AccelClearedCallback dlg, Flag!"After" after = No.After)
  {
   ...
   * Returns: Signal ID
   */
  ulong connectAccelEdited(AccelEditedCallback dlg, Flag!"After" after = No.After)
  {
    extern(C) void _cmarshal(GClosure* _closure, GValue* _returnValue, uint _nParams, const(GValue)* _paramVals, void* _invocHint, void* _marshalData)
    {
