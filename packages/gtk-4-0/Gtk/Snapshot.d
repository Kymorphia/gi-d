...
class Snapshot : DGdkSnapshot
{
   ...
   * If the shader requires textures $(LPAREN)see [Gsk.GLShader.getNTextures]$(RPAREN),
  ...
  {
    gtk_snapshot_push_gl_shader(cast(GtkSnapshot*)cPtr, shader ? cast(GskGLShader*)shader.cPtr(false) : null, bounds ? cast(graphene_rect_t*)bounds.cPtr(false) : null, takeArgs ? cast(GBytes*)takeArgs.cPtr(true) : null);
  }
