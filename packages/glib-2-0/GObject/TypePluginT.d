...
template TypePluginT()
{
  ...
  {
    g_type_plugin_complete_interface_info(cast(GTypePlugin*)cPtr, instanceType, interfaceType, &info);
  }
  ...
  {
    g_type_plugin_complete_type_info(cast(GTypePlugin*)cPtr, gType, info ? cast(GTypeInfo*)info.cPtr : null, valueTable ? cast(GTypeValueTable*)valueTable.cPtr : null);
  }
}
